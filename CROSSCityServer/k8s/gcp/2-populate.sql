...
INSERT INTO route (id, image_url, main_locale)
VALUES ('route_1',
        'https://3.bp.blogspot.com/-gxWfAA_EdNI/Un0o1LzFOwI/AAAAAAAAJmo/KfsQMYxvHCo/s1600/1-4277-Marcas.jpg', 'pt');

INSERT INTO route_lang (route_id, lang, name, description)
VALUES ('route_1', 'pt', 'Alameda - Técnico Lisboa',
       ...
       ('route_1', 'en', 'Alameda - Técnico Lisboa',
...
VALUES ('poi_1_1', '(38.73661764318405, -9.137217959885179)', 'https://aeist.pt/',
        'https://lh5.googleusercontent.com/p/AF1QipPv9C1ZWF3OeOWExXRO0yHe49UdIY0Q4gFpUbOs=w750-h401-p-k-no', 'pt'),
       ('poi_1_2', '(38.74251285902285, -9.138224647304572)', 'https://tecnico.ulisboa.pt/pt/tag/museu-faraday/',
        'https://tecnico.ulisboa.pt/files/2017/02/inauguracao-do-museu-faraday-no-tecnico-1140x641.jpg', 'pt'),
       ('poi_1_3', '(38.73700329289798, -9.139338003537375)', 'https://bist.tecnico.ulisboa.pt/apresentacao/',
        'https://fenix.tecnico.ulisboa.pt/downloadFile/3779580646309/Biblioteca.Imagem_1629.JPG', 'pt');

INSERT INTO poi_lang (poi_id, lang, name, description)
VALUES ('poi_1_1', 'pt', 'AEIST - Associação dos Estudantes do Instituto Superior Técnico',
       ...
       ('poi_1_1', 'en', 'AEIST - Student Association of Instituto Superior Técnico',
       ...
       ('poi_1_3', 'pt', 'BIST - Biblioteca do Instituto Superior Técnico',
       ...
       ('poi_1_3', 'en', 'BIST - Library of Instituto Superior Técnico',
...
INSERT INTO route_waypoint (route_id, waypoint_id)
VALUES ('route_1', 'waypoint_1_1'),
       ('route_1', 'waypoint_1_2'),
       ('route_1', 'waypoint_1_3');
...
INSERT INTO route (id, image_url, main_locale)
VALUES ('route_2',
        'https://wp105917.wpdns.ca/wp-content/uploads/2021/01/Green-Cedar-Home-Banner-1-1.jpg', 'en');

INSERT INTO route_lang (route_id, lang, name, description)
VALUES ('route_2', 'pt', 'Lar Doce Lar',
...
INSERT INTO poi (id, world_coord, web_url, image_url, main_locale)
VALUES ('poi_2_1', '(32.23772, 161.06769)', 'https://en.wikipedia.org/wiki/Bedroom',
        'https://www.bocadolobo.com/en/inspiration-and-ideas/wp-content/uploads/2020/08/feature-image-81.jpg', 'en'),
       ('poi_2_2', '(32.23772, 161.06769)', 'https://en.wikipedia.org/wiki/Living_room',
...
INSERT INTO route_waypoint (route_id, waypoint_id)
VALUES ('route_2', 'waypoint_2_1'),
       ('route_2', 'waypoint_2_2');
...
INSERT INTO route (id, image_url, main_locale)
VALUES ('route_3',
        'https://fenix.tecnico.ulisboa.pt/downloadFile/845043405435819/Tagus%20Novo%20Med..jpg', 'en');

INSERT INTO route_lang (route_id, lang, name, description)
VALUES ('route_3', 'pt', 'IST - Taguspark',
...
INSERT INTO poi (id, world_coord, web_url, image_url, main_locale)
VALUES ('poi_3_1', '(38.73715291107833, -9.302635744572406)', 'https://en.wikipedia.org/wiki/Office',
        'https://as2.ftcdn.net/v2/jpg/02/40/20/89/1000_F_240208923_VW0K7K2CKSBORxHaq0FyDyjt4qJLuCjG.jpg', 'en'),
       ('poi_3_2', '(38.73715291107833, -9.302635744572406)', 'https://www.nasa.gov/',
        'https://i.pinimg.com/originals/8c/27/19/8c27193fdf569ffb89f1279730fc7224.jpg',
        'en'),
       ('poi_3_3', '(38.73715291107833, -9.302635744572406)', 'https://en.wikipedia.org/wiki/Snack_bar',
        'https://media.timeout.com/images/105208214/image.jpg',
        'en');

INSERT INTO poi_lang (poi_id, lang, name, description)
VALUES ('poi_3_1', 'pt', 'Escritório',
...
INSERT INTO route_waypoint (route_id, waypoint_id)
VALUES ('route_3', 'waypoint_3_1'),
       ('route_3', 'waypoint_3_2'),
       ('route_3', 'waypoint_3_3');
...
INSERT INTO route (id, image_url, main_locale)
VALUES ('route_4',
        'https://www.planetware.com/photos-large/P/st-georges-castle.jpg', 'pt');

INSERT INTO route_lang (route_id, lang, name, description)
VALUES ('route_4', 'pt', 'CROSS Scavenger - Demo',
        'Rota usada no contexto do CROSS Scavenger para motivos de demonstração.'),
       ('route_4', 'en', 'CROSS Scavenger - Demo',
        'Route used in the CROSS Scavenger context for demonstration purposes.');

INSERT INTO poi (id, world_coord, web_url, image_url, main_locale)
VALUES ('alvalade', '(38.754438597, -9.146783678)', 'https://pt.wikipedia.org/wiki/Alvalade_(Lisboa)',
        'https://offloadmedia.feverup.com/lisboasecreta.co/wp-content/uploads/2020/10/19150815/%40Junta-de-Freguesia-de-Alvalade-1024x683.jpg', 'pt'),
       ('comercio', '(38.709016121, -9.136898741)', 'https://pt.wikipedia.org/wiki/Rua_do_Com%C3%A9rcio',
        'https://toponimialisboa.files.wordpress.com/2015/05/0-rua-do-comc3a9rcio.jpg', 'pt'),
       ('gulbenkian', '(38.737831, -9.153553)', 'https://gulbenkian.pt/',
        'https://gulbenkian.pt/wp-content/uploads/2017/07/Dia-Calouste-Gulbenkian.jpg', 'pt'),
       ('jeronimos', '(38.697520754, -9.205973155)', 'http://www.patrimoniocultural.gov.pt/pt/museus-e-monumentos/dgpc/m/mosteiro-dos-jeronimos/',
        'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d6/The_Jer%C3%B3nimos_Monastery_or_Hieronymites_Monastery.png/265px-The_Jer%C3%B3nimos_Monastery_or_Hieronymites_Monastery.png', 'pt'),
       ('oceanario', '(38.763543, -9.093752)', 'https://www.oceanario.pt/',
        'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1a/9c/96/f3/caption.jpg?w=300&h=300&s=1', 'pt'),
       ('sb', '(38.709743545, -9.133603441)', 'https://pt.wikipedia.org/wiki/S%C3%A9_(Lisboa)',
        'https://cdn.olhares.com/client/files/foto/big/704/7045749.jpg', 'pt');

INSERT INTO poi_lang (poi_id, lang, name, description)
VALUES ('alvalade', 'pt', 'Alvalade',
       ...
       ('gulbenkian', 'en', 'Calouste Gulbenkian Museum',
       ...
       ('jeronimos', 'pt', 'Mosteiro dos Jerónimos',
       ...
       ('jeronimos', 'en', 'Jerónimos Monastery',
...
INSERT INTO route_waypoint (route_id, waypoint_id)
VALUES ('route_4', 'waypoint_4_1'),
       ('route_4', 'waypoint_4_2'),
       ('route_4', 'waypoint_4_3'),
       ('route_4', 'waypoint_4_4'),
       ('route_4', 'waypoint_4_5'),
       ('route_4', 'waypoint_4_6');
...
INSERT INTO cross_user (username, password_hash, password_salt, joined)
VALUES ('alice',
        decode(
                ...
                'hex'),
        decode('8C811A6568ACCF4FFE91D83AE1476711', 'hex'),
        '2020-03-25T18:47:00.000Z'),
       ('bob',
        decode(
                '5A37255468F647A9CB33F7DB1326EB4669C80488E4342624EC36D3D6A66EFCFC2D97401AA6DDBB0F3E4EE47F1005E84FC58C3449CA393D07CDF812B96775DF97',
                'hex'),
...
VALUES ('latest', '2022-04-05T16:45:05.699Z');
