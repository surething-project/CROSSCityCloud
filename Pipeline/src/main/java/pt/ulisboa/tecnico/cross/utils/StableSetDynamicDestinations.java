...
public class StableSetDynamicDestinations extends DynamicDestinations<TableRow, String> {
  private final String project;
  private final String dataset;
  private final String tablePrefix;

  public StableSetDynamicDestinations(ScavengerOptions options) {
    this.project = options.getProject();
    this.dataset = options.getBigQueryCrossDataset();
    this.tablePrefix = options.getBigQueryStableSetTablePrefix();
  }
  ...
  public TableDestination getTable(String destination) {
    return new TableDestination(
            ...
            "Stable Set table for poiId and date " + destination);
  }
